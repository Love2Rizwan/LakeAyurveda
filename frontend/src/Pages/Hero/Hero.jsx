...
const images = [
  {
    ...
    imgPath:
      "/public/images/Tila Oil + Time & Fertility Booster.png",
  },
  {
      ...
      <Box sx={{ maxWidth: 1100, flexGrow: 1 }}>
        ...
        >
          {images.map((step, index) => (
            <div className="d-flex align-item-center justify-content-center" key={step.label}>
