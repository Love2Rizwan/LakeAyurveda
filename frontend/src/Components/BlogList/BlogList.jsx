              ...
              <Link to={`/blogs/${blog.id}`}>
                <div>
                  <img
                    ...
                    className="object-fit h-64 md:h-52 w-full"
                    alt={blog.title}
                  />
                </div>
                <div className="p-4 flex justify-between">
                  <div>
                    ...
                    <p className="pb-2 text-sub-title">
                    ...
                    <span className="inline-block bg-gray-50 shadow-md rounded-full px-2 md:px-3 py-1 text-sm font-semibold text-gray-700 mr-2 mb-2">
                      #{blog.category}
                    </span>
                  </div>
                </div>
